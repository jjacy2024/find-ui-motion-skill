...
7. Unless the user requests quick results only, read [visual-deep-match.md](visual-deep-match.md), recall 48 cases by default and at most 64, then narrow to the documented 24-item live-check and 16-item capture limits before returning eight eligible ranked results by default or at most ten when explicitly requested.
